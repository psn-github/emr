...
- **Web frontend:** React + TypeScript, a component library themed to Oxford Medical's design system (Cormorant Garamond + DM Sans/Inter Tight; Oxford palette), with **first-class RTL** (logical CSS properties, dir-aware layout). Server-state via TanStack Query.
